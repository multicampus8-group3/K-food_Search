...
public class CountryController {
	...
	*/
	//home_word 테스트
	@GetMapping("/restaurantList_default") // "/restaurantList_default?nation=${mvo.favornation}" 주소값 등록시 이쪽으로 값 넘어옴.
	public ModelAndView restaurantList_default(memberVO mVO) {//매개변수로 member_table의 favoernation을 가져옴
