...
function reserveListView(){
	$.ajax({
		...
		success:function(result){
			var html="<li class='listMenu'>식당명</li><li class='listMenu'>광고 시작 예정일</li><li class='listMenu'>광고 종료 예졍일</li><li class='listMenu'>광고 상태</li><li class='listMenu'>광고 신청일</li>";
